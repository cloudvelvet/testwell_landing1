...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-brand-black text-neutral-400 py-12 sm:py-16 border-t border-white/10">
      <div className="max-w-page mx-auto px-6 sm:px-8 lg:px-12">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8 pb-10 border-b border-white/10">
          {/* Brand Column */}
          <div>
            <a href={LINKS.top} className="flex items-center gap-2.5 text-white font-extrabold text-2xl tracking-tighter" aria-label="TestWell 랜딩페이지 맨 위로">
          ...
          {/* Quick Links */}
          <nav className="flex flex-wrap items-center gap-6 sm:gap-8 text-sm font-medium text-neutral-300">
