...
디자인과 정보구조는 확정 상태다. 제작 안내 안의 MeasurementContext는 “문항을 준비하기 전에 / 이 검사로 무엇을 알고 싶나요?”라는 짧은 하위 안내다. 이후 작업은 정합성 갱신에 한정하며, 배포 준비 여부는 docs/DEPLOYMENT_BLOCKERS.md를 따른다.
